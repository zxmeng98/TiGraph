...
WANDB_DISABLED=True TOKENIZERS_PARALLELISM=False CUDA_VISIBLE_DEVICES=0 python -m lm_workloads.lm_core.train_lm dataset ogbn-arxiv 2>&1 | tee train_test_bs128.log
